...
53. WHERE col != NULL 和 col IS NOT NULL是同一个意思吗
...
56. ShardingSphere中如何解决读从节点请求延迟问题
...
58. 在 MySQL RR 级别下，幻读通常发生在**“跨越快照”**的操作中。最经典的例子是：
...
62. 如果事务 A 正在写，事务 B 也在写，但它们修改的不是同一行，而是相邻的两行，在什么特殊情况下它们依然会互相阻塞
